...
# Initialize models
# here we have two models that will be created
model1, model2 = InceptionV3((299, 299, 3), 1000)
...
model1.compile(optimizer=tf.keras.optimizers.Adam(), loss=loss, metrics='accuracy')
model2.compile(optimizer=tf.keras.optimizers.Adam(), loss=loss, metrics='accuracy')
...
# Save models
# model1.save('path_to_sav_dir/model1')
# model2.save('path_to_sav_dir/model2')